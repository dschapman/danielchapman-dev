...
<main>
  ...
  <div class="projects">
    <Project
      ...
      description="This site is constructed to hold articles, poems,
      notes, and whatever else I want to put in it. Featuring bidirectional links, link previews, and
